document.addEventListener("DOMContentLoaded", function()
{
	...
	}, "es6", "es3"), t = function(t)
	{
		var a = function(a, e, s)
		{
			...
			{
				if (o = o || !1, s = s ||
					{}, i.clearIfNotMatch = t.jMaskGlobals.clearIfNotMatch, i.byPassKeys = t.jMaskGlobals.byPassKeys, i.translation = t.extend(
					{}, t.jMaskGlobals.translation, s.translation), i = t.extend(!0,
					{}, i, s), n = r.getRegexMask(), o) r.events(), r.val(r.getMasked());
				else
				{
		...
		{}, (r = t.jMaskGlobals = t.extend(!0,
		{}, r, t.jMaskGlobals)).dataMask && t.applyDataMask(), setInterval(function()
		{
		...
		sendCart: function()
		{
			...
			t.ajax(
			{
				...
				complete: function(s)
				{
					...
					{
						r = e.getProducts() ||
						{}, e.commonResult(r, "updateCommonResult"), e.getSmartBasketMinState(r, "updateSmartBasketMin"), e.showProducts(r)
					}, 4e3)
				}
			})
		},
